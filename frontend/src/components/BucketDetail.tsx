...
const BucketDetail: React.FC<BucketDetailProps> = ({
	...
	const handleDelete = () => {
		if (
			window.confirm(
				`Are you sure you want to delete the bucket "${bucketName}"? This will not delete the receipts, but they will become unallocated.`,
			)
		) {
			...
			<div className="flex justify-between items-end mb-8">
				<div className="flex-1">
						...
						<div className="flex flex-col gap-2 max-w-md">
							<div className="flex gap-2">
								...
								<button
									...
									disabled={!editName.trim() || isNameTaken(editName, bucketId)}
								>
									<Check size={24} />
								</button>
								<button
					...
					<p className="text-muted mt-2">
						Transaction history for this period.
					</p>
				</div>
				<div className="text-right">
					...
					<div className="text-4xl font-bold text-primary">
						$
						{bucketTotal.toLocaleString(undefined, {
