...
from taxos.tenant.unallocated_receipts.entity import UnallocatedReceipts
from taxos.tenant.unallocated_receipts.load.command import LoadUnallocatedReceipts
...
def handle(command: LoadUnallocatedReceipts) -> UnallocatedReceipts:
